...

{
  ...
  "lifePath": {
    "title": "一句話封號（如：大器晚成的硬核技術流 / 天生的社交操盤手）",
    "mainAxis": "人生主軸描述（3-4句話，要像在寫一份高階戰略計畫，不是在背課文。結合當前年齡和大運時間點，告訴命主：你現在在哪個階段、接下來會怎樣、該把油門踩在哪裡）",
    "weapons": [
      { "emoji": "💡", "label": "神級武器名", "desc": "一句話描述這個優勢在現實中怎麼用（要具體、要狠）" }
    ],
    "bossFights": [
      { "emoji": "⚠️", "label": "要破關的罩門", "desc": "一句話描述要克服什麼（說人話，不要說教）" }
    ],
    "battlefields": [
      { "emoji": "🎯", "label": "適合職業/方向", "desc": "為什麼適合（一句話）" }
    ]
  }
}
